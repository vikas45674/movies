...
BOT_TOKEN = environ.get('BOT_TOKEN', '78077071729403:AAF_9YdeA7-USEr-M9wf1a-UacYOy-fWWTo')
#---------------------------------------------------------------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '633111330').split()]
USERNAME = environ.get('USERNAME', "https://t.me/Donxxnx") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002568209894'))
...
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://vikassonawale0:JWyQFas7vlG1bkaL@cluster0.beermge.mongodb.net/?retryWrites=true&w=majority")
